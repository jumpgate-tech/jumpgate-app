var jt=Object.defineProperty;var Wt=(s,i,r)=>i in s?jt(s,i,{enumerable:!0,configurable:!0,writable:!0,value:r}):s[i]=r;var Oe=(s,i,r)=>Wt(s,typeof i!="symbol"?i+"":i,r);(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const f of document.querySelectorAll('link[rel="modulepreload"]'))t(f);new MutationObserver(f=>{for(const w of f)if(w.type==="childList")for(const R of w.addedNodes)R.tagName==="LINK"&&R.rel==="modulepreload"&&t(R)}).observe(document,{childList:!0,subtree:!0});function r(f){const w={};return f.integrity&&(w.integrity=f.integrity),f.referrerPolicy&&(w.referrerPolicy=f.referrerPolicy),f.crossOrigin==="use-credentials"?w.credentials="include":f.crossOrigin==="anonymous"?w.credentials="omit":w.credentials="same-origin",w}function t(f){if(f.ep)return;f.ep=!0;const w=r(f);fetch(f.href,w)}})();function _t(){return K("/api/host")}function Ee(){return K("/api/catalog")}function Ie(){return K("/api/targets")}function at(s){return K("/api/targets",{method:"POST",headers:me,body:JSON.stringify(s)})}function Kt(s){return K(`/api/targets/${encodeURIComponent(s)}`,{method:"DELETE"})}function zt(s,i){return K(`/api/targets/${encodeURIComponent(s)}/disk?path=${encodeURIComponent(i)}`)}function Gt(s,i){return K(`/api/targets/${encodeURIComponent(s)}/setup`,{method:"POST",headers:me,body:JSON.stringify(i)})}function Ze(s,i){const r=new EventSource(`/api/targets/${encodeURIComponent(s)}/setup/stream`);return r.onmessage=t=>{try{i(JSON.parse(t.data))}catch{}},()=>r.close()}function Jt(s,i){const r=new EventSource(`/api/targets/${encodeURIComponent(s)}/monitor/stream`);return r.onmessage=t=>{try{i(JSON.parse(t.data))}catch{}},()=>r.close()}function Vt(s,i=200){return K(`/api/targets/${encodeURIComponent(s)}/logs?n=${i}`)}function Yt(s,i){const r=new EventSource(`/api/targets/${encodeURIComponent(s)}/logs/stream`);return r.onmessage=t=>{try{i(JSON.parse(t.data))}catch{}},()=>r.close()}function st(s,i){const r=i===void 0?{}:{lines:i};return K(`/api/targets/${encodeURIComponent(s)}/explain`,{method:"POST",headers:me,body:JSON.stringify(r)})}function Zt(s,i,r){return K(`/api/targets/${encodeURIComponent(s)}/services/${i}/${r}`,{method:"POST"})}function Xt(s,i){return K(`/api/targets/${encodeURIComponent(s)}/services/${i}/clear`,{method:"POST",headers:me,body:JSON.stringify({Confirm:i})})}function Qt(s){return K(`/api/targets/${encodeURIComponent(s)}/du`)}function en(s){return K(`/api/targets/${encodeURIComponent(s)}/endpoints`)}function tn(s){return K(`/api/targets/${encodeURIComponent(s)}/firewall`)}function nn(s){return K(`/api/targets/${encodeURIComponent(s)}/diagnostics`)}function an(s){return K(`/api/targets/${encodeURIComponent(s)}/diagnostics/latest`)}function sn(s){return K(`/api/targets/${encodeURIComponent(s)}/containers`)}function on(s,i,r){return K(`/api/targets/${encodeURIComponent(s)}/containers/${i}/${r}`,{method:"POST"})}async function rn(s,i){const r=await fetch(`/api/targets/${encodeURIComponent(s)}/containers/${i}/wipe`,{method:"POST",headers:me,body:JSON.stringify({Confirm:i})}),t=await r.text();let f=null;try{f=t?JSON.parse(t):null}catch{}if(f&&typeof f=="object"&&"report"in f)return f;const w=f&&typeof f=="object"&&typeof f.error=="string"?f.error:r.statusText||`HTTP ${r.status}`;throw new we(r.status,w)}function cn(s,i){return K(`/api/targets/${encodeURIComponent(s)}/containers/${i}/provision`,{method:"POST"})}async function ln(s){const i=await fetch(`/api/targets/${encodeURIComponent(s)}/containers/devnet/reset`,{method:"POST",headers:me}),r=await i.text();let t=null;try{t=r?JSON.parse(r):null}catch{}if(t&&typeof t=="object"&&"report"in t)return t;const f=t&&typeof t=="object"&&typeof t.error=="string"?t.error:i.statusText||`HTTP ${i.status}`;throw new we(i.status,f)}function dn(s,i,r){return K(`/api/targets/${encodeURIComponent(s)}/containers/${i}/config`,{method:"PUT",headers:me,body:JSON.stringify(r)})}function dt(){return K("/api/gateways")}async function un(s){await K(`/api/orphans/${encodeURIComponent(s)}`,{method:"DELETE"})}function pn(s){return K("/api/gateways",{method:"POST",headers:me,body:JSON.stringify(s)})}function hn(s){return K(`/api/gateways/${encodeURIComponent(s)}/tls/verify`)}function fn(s){return K(`/api/gateways/${encodeURIComponent(s)}/traffic`)}function mn(s){return K(`/api/gateways/${encodeURIComponent(s)}/analytics`)}function bn(s,i=!1){const r=i?"?refresh=1":"";return K(`/api/gateways/${encodeURIComponent(s)}/capabilities${r}`)}function gn(s){return K(`/api/gateways/${encodeURIComponent(s)}`,{method:"DELETE"})}function yn(s,i){return K(`/api/gateways/${encodeURIComponent(s)}/config`,{method:"PUT",headers:me,body:JSON.stringify(i)})}function vn(s,i){return K(`/api/gateways/${encodeURIComponent(s)}/${i}`,{method:"POST"})}function $n(s){return K(`/api/gateways/${encodeURIComponent(s)}/provision`,{method:"POST"})}async function wn(s){const i=await fetch(`/api/gateways/${encodeURIComponent(s)}/wipe`,{method:"POST",headers:me,body:JSON.stringify({Confirm:s})}),r=await i.text();let t=null;try{t=r?JSON.parse(r):null}catch{}if(t&&typeof t=="object"&&"report"in t)return t;const f=t&&typeof t=="object"&&typeof t.error=="string"?t.error:i.statusText||`HTTP ${i.status}`;throw new we(i.status,f)}function kn(s){return K(`/api/chainlist/${s}`)}function Tn(s,i){return K(`/api/gateways/${encodeURIComponent(s)}/knownset/${i}`)}function Cn(){return K("/api/settings")}function Sn(s){return K("/api/settings",{method:"PUT",headers:me,body:JSON.stringify(s)})}class we extends Error{constructor(r,t,f,w){super(t);Oe(this,"status");Oe(this,"hint");Oe(this,"code");this.name="ApiError",this.status=r,this.hint=f,this.code=w}}const me={"Content-Type":"application/json"};async function K(s,i){const r=await fetch(s,i);if(!r.ok){let f=r.statusText||`HTTP ${r.status}`,w,R;try{const b=await r.json();b&&typeof b.error=="string"&&b.error&&(f=b.error),b&&typeof b.hint=="string"&&b.hint&&(w=b.hint),b&&typeof b.code=="string"&&b.code&&(R=b.code)}catch{}throw new we(r.status,f,w,R)}if(r.status===204)return;const t=await r.text();return t?JSON.parse(t):void 0}const ot="https://learn.valve.city/rpc";function n(s){return s.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ie(s,i){const r=s&&i&&i!==ot?` <span class="footer-sep">·</span> <a href="${n(i)}" target="_blank" rel="noopener noreferrer">${n(s)}</a>`:"";return`
  ...
  `}function Ne(s){s.querySelectorAll(".dropdown.open").forEach(i=>{var r;i.classList.remove("open"),(r=i.querySelector(".dropdown-trigger"))==null||r.setAttribute("aria-expanded","false")})}function Xe(s,i){s.addEventListener("click",f=>{const w=f.target,R=w.closest(".dropdown-trigger");if(R&&s.contains(R)){const A=R.closest(".dropdown"),W=!!A&&!A.classList.contains("open");Ne(s),A&&W&&(A.classList.add("open"),R.setAttribute("aria-expanded","true"));return}const b=w.closest(".dropdown-option");if(b&&s.contains(b)){const A=b.closest(".dropdown");Ne(s),i((A==null?void 0:A.dataset.dropdown)??"",b.dataset.value??"");return}Ne(s)});const r=f=>{if(!s.isConnected){document.removeEventListener("click",r),document.removeEventListener("keydown",t);return}const w=f.target;(!w.closest(".dropdown")||!s.contains(w))&&Ne(s)},t=f=>{if(!s.isConnected){document.removeEventListener("click",r),document.removeEventListener("keydown",t);return}f.key==="Escape"&&Ne(s)};document.addEventListener("click",r),document.addEventListener("keydown",t)}const _e="app-modal";let We=null;function ne(s,i){V();const r=document.createElement("div");r.className="modal-overlay",r.id=_e,r.innerHTML=`<div class="modal">${s}</div>`,r.addEventListener("click",f=>{const w=f.target.closest("[data-modal-action]");w!=null&&w.dataset.modalAction?i(w.dataset.modalAction):f.target===r&&i("cancel")});const t=f=>{f.key==="Escape"&&i("cancel")};document.addEventListener("keydown",t),We=t,document.body.appendChild(r)}function V(){var s;(s=document.getElementById(_e))==null||s.remove(),We&&(document.removeEventListener("keydown",We),We=null)}function He(){return document.querySelector(`#${_e} .modal`)}function Be(s){return new Promise(i=>{var f;let r=!1;const t=w=>{r||(r=!0,V(),i(w))};ne(`
      ...
      `,w=>t(w==="confirm")),(f=document.querySelector(`#${_e} [data-modal-action="confirm"]`))==null||f.focus()})}const Ge=5e3,In=60;function Rn(s,i){let r=!1,t=null,f=null,w=null,R=null;const b=[];s.innerHTML=`<div id="an-body"><p class="muted">Loading…</p></div><div id="an-footer">${ie()}</div>`;const A=s.querySelector("#an-body");ve(s,(g,d)=>{var k;g==="toggle-endpoint"&&((k=d.closest(".an-endpoint"))==null||k.classList.toggle("expanded"))}),W();async function W(){try{t=((await dt()).gateways??[]).find(d=>d.id===i)??null}catch(g){if(r)return;w=String(g instanceof Error?g.message:g),B();return}if(!r){if(!t){B();return}await U(),R=window.setInterval(()=>void U(),Ge)}}async function U(){try{const g=await mn(i);if(r)return;z(g),f=g,w=null}catch(g){if(r)return;w=String(g instanceof Error?g.message:g)}B()}function z(g){if(!g.enabled||g.error)return;const d=b[b.length-1];d&&d.since!==g.since&&(b.length=0);const k=new Map;for(const P of g.networks??[])k.set(P.chainId,P.received);b.push({t:Date.now(),since:g.since,received:k}),b.length>In&&b.shift()}function B(){r||(A.innerHTML=q())}function q(){return w&&!f?`<h1>Analytics</h1><p class="error">${n(w)}</p><p><a href="#/rpc">← Back to RPC</a></p>`:t?`
      ${I(t)}
    ...
    `}function se(g){const d=[];return g.cached.count>0&&d.push(`${n(ae(g.cached.count))} of these were answered by the gateway itself from its own
      ...
      <div class="surface-scroll">
        <table class="surface an-latency">
          ...
          <tbody>
            ${d.map(k=>ue(k.label,k.l)).join("")}
          </tbody>
        </table>
      </div>
    `}function ue(g,d){return`
      <tr>
        <td><code>${n(g)}</code></td>
    ...
    `}function fe(g){const d=g.buckets??[];if(d.length===0||g.count===0)return'<span class="muted small">—</span>';let k=0;const P=[];for(const F of d){const h=F.count-k;k=F.count,P.push({label:oe(F.le),n:Math.max(0,h)})}return P.reduce((F,h)=>F+h.n,0)===0?'<span class="muted small">—</span>':`
      <span class="an-dist" title="${n(P.filter(F=>F.n>0).map(F=>`${F.n} ${F.label}`).join(" · "))}">
        ${P.map((F,h)=>F.n===0?"":`<span class="an-band an-band-${Math.min(h,4)}" style="flex:${F.n}"></span>`).join("")}
      </span>
    ...
    `}function pe(g){const d=g.errors??[],k=d.reduce((L,F)=>L+F.count,0),P=d.length>0;return`
    ...
    `}return()=>{r=!0,R!==null&&window.clearInterval(R)}}function Ae(s){return!Number.isFinite(s)||s<0?"—":s>0&&s<5e-4?"<1ms":s<1?`${Math.round(s*1e3)}ms`:s<60?`${s<10?s.toFixed(1):Math.round(s)}s`:`${Math.round(s/60)}m`}const Ln=85,Je={exec:"Execution",beacon:"Beacon"};function Nn(s,i){let r=!1,t=null,f=null,w=null,R=null,b=null,A=null,W=null,U=null;const z={exec:null,beacon:null};let B=null;s.innerHTML=`<h1>Dashboard: ${n(i)}</h1><div id="dash-body"><p class="muted">Loading…</p></div><div id="dash-footer">${ie()}</div>`;const q=s.querySelector("#dash-body"),I=s.querySelector("#dash-footer");q.addEventListener("click",d=>{const k=d.target.closest("[data-action]");if(!k||!q.contains(k))return;const P=k.dataset.action;if(P==="svc-action"){const L=k.dataset.svc,F=k.dataset.kind;L&&F&&pe(L,F)}else if(P==="open-clear"){const L=k.dataset.svc;L&&ge(L)}else if(P==="copy"){const L=k.dataset.copy;L&&be(k,L)}else P==="retry-du"?p():P==="retry-endpoints"&&$()}),C();async function C(){let d,k;try{const[L,F]=await Promise.all([Ie(),Ee()]);d=L.find(h=>h.id===i),k=F}catch(L){if(r)return;q.innerHTML=`<p class="error">Failed to load target: ${n(String(L))}</p>`;return}if(r)return;if(!d){q.innerHTML=`<p class="error">Target "${n(i)}" not found. <a href="#/targets">Back to targets</a></p>`;return}if(!d.wire){q.innerHTML=`<p class="muted">This target hasn't completed setup yet. <a href="#/setup/${encodeURIComponent(i)}">Run the setup wizard →</a></p>`;return}const P=k==null?void 0:k.networks.find(L=>L.ChainID===d.wire.ChainID);P&&(I.innerHTML=ie(P.Name,P.LearnURL)),q.innerHTML='<p class="muted">Connecting…</p>',t=Jt(i,L=>{r||(N(L),f=L,w=L,H())}),p(),$()}async function p(){A=null;try{b=await Qt(i)}catch(d){b=null,A=String(d instanceof Error?d.message:d)}r||H()}async function $(){U=null;try{W=await en(i)}catch(d){W=null,U=String(d instanceof Error?d.message:d)}r||H()}function N(d){if(!f)return;const k=(new Date(d.at).getTime()-new Date(f.at).getTime())/1e3,P=d.execHead-f.execHead;if(k>0&&P>=0){const L=P/k;R=R===null?L:R*.7+L*.3}}function H(){if(!w)return;const d=w;q.innerHTML=`
    ...
    `;if(A)return`
      ...
      `;const L=b.ExpectedExecBytes>0?Math.min(b.ExecBytes/b.ExpectedExecBytes*100,100):0,F=b.ExpectedBeaconBytes>0?Math.min(b.BeaconBytes/b.ExpectedBeaconBytes*100,100):0,{lag:h,eta:y}=Q(d),x=h!==null&&h>0&&R!==null&&R>0;return`
      <div class="card ${k?"card-warn":""}">
        <h3>Storage</h3>
        ${P}
    ...
    `}function ce(d,k){const P=Je[d],L=z[d],F=(h,y,x)=>`<button class="btn btn-ghost" data-action="svc-action" data-svc="${d}" data-kind="${h}" ${L!==null||x?"disabled":""}>${L===h?re():n(y)}</button>`;return`
    ...
    `}function re(){return'<span class="spinner" aria-label="working"></span>'}async function pe(d,k){if(z[d]===null){z[d]=k,B=null,H();try{await Zt(i,d,k)}catch(P){B=`${Je[d]} ${k} failed: ${P instanceof Error?P.message:String(P)}`}z[d]=null,r||H()}}async function be(d,k){const P=await De(k),L=d.textContent;d.textContent=P?"Copied!":"Copy failed",setTimeout(()=>{r||(d.textContent=L)},1500)}function ge(d){const k=Je[d],P=b?Ce(d==="exec"?b.ExecBytes:b.BeaconBytes):"unknown (disk usage hasn't loaded)";ne(`
      ...
      `,h=>{if(h==="cancel"){V();return}h==="confirm"&&g(d)});const L=document.getElementById("clear-confirm-input"),F=document.getElementById("clear-confirm-btn");L==null||L.addEventListener("input",()=>{F&&(F.disabled=L.value.trim()!==d)}),L==null||L.focus()}async function g(d){const k=document.getElementById("clear-confirm-btn");k&&(k.disabled=!0,k.textContent="Clearing…");try{await Xt(i,d),V(),p()}catch(P){const L=He();if(L){const F=document.createElement("p");F.className="error small",F.textContent=`Clear failed: ${P instanceof Error?P.message:String(P)}`,L.appendChild(F)}k&&(k.disabled=!1,k.textContent="Clear and resync")}}return()=>{r=!0,t==null||t(),V()}}const it=500,ct="valve-node-app.explain-consent";function An(s,i){let r=!1,t=null;const f=[];s.innerHTML=`
    <h1>Logs: ${n(i)}</h1>
    <div id="logs-body"><p class="muted">Loading…</p></div>
    <div id="logs-footer">${ie()}</div>
  `;const w=s.querySelector("#logs-body"),R=s.querySelector("#logs-footer");ve(s,C=>{C==="explain"&&U()}),b();async function b(){let C,p;try{const[N,H]=await Promise.all([Ie(),Ee()]);C=N.find(G=>G.id===i),p=H}catch(N){if(r)return;w.innerHTML=`<p class="error">Failed to load target: ${n(String(N))}</p>`;return}if(r)return;if(!C){w.innerHTML=`<p class="error">Target "${n(i)}" not found. <a href="#/targets">Back to targets</a></p>`;return}if(!C.wire){w.innerHTML=`<p class="muted">This target hasn't completed setup yet. <a href="#/setup/${encodeURIComponent(i)}">Run the setup wizard →</a></p>`;return}const $=p==null?void 0:p.networks.find(N=>N.ChainID===C.wire.ChainID);$&&(R.innerHTML=ie($.Name,$.LearnURL));try{const N=await Vt(i,200);if(r)return;f.push(...N)}catch(N){if(r)return;w.innerHTML=`<p class="error">Failed to load logs: ${n(String(N))}</p>`;return}A(),t=Yt(i,N=>{r||(f.push(N),f.length>it&&f.splice(0,f.length-it),A())})}function A(){const C=f.filter($=>$.severity==="error"||$.severity==="critical");w.innerHTML=`
      <div class="logs-layout">
        ...
        <section class="logs-errors">
          ...
          <div class="log-lines">${C.length?C.slice().reverse().map(W).join(""):'<p class="muted">No errors seen yet.</p>'}</div>
        </section>
      </div>
    `;const p=w.querySelector(".log-lines");p&&(p.scrollTop=p.scrollHeight)}function W(C){const p=C.severity||"info",$=C.learnUrl?` <a href="${n(C.learnUrl)}" target="_blank" rel="noopener noreferrer">learn →</a>`:"";return`
    ...
    `}async function U(){const C=f.filter($=>$.severity==="error"||$.severity==="critical").map($=>$.line).slice(-40);if(!(localStorage.getItem(ct)==="1")){z(C);return}await B(C)}function z(C){const p=C.length?`<pre class="explain-excerpt">${C.map($=>n($)).join(`
`)}</pre>`:'<p class="muted">No recent error lines are loaded yet — the server will auto-select its own recent error/critical lines instead.</p>';q(`
    ...
    `,$=>{$==="proceed"?(localStorage.setItem(ct,"1"),I(),B(C)):I()})}async function B(C){q('<h2>Explain with AI</h2><p class="muted">Asking the AI provider…</p>',()=>{});try{const p=C.length?await st(i,C):await st(i);if(r)return;q(`
        <h2>Explanation</h2>
...
`)||"(no log lines — general question only)"}</pre>
      ...
      `,$=>{$==="close"&&I()})}catch(p){if(r)return;if(p instanceof we&&p.status===409){q(`
    ...
    `}async function q(I,C){const p=await De(C),$=I.textContent;I.textContent=p?"Copied!":"Copy failed",setTimeout(()=>{r||(I.textContent=$)},1500)}return()=>{r=!0}}const Dn=[{value:"",label:"None"},{value:"gemini",label:"Gemini"},{value:"groq",label:"Groq"},{value:"ollama",label:"Ollama"}];function Un(s){let i=!1,r=!1,t=!1,f=null,w=!1,R=null,b=null;s.innerHTML=`<h1>Settings</h1><div id="settings-body"><p class="muted">Loading…</p></div>${ie()}`;const A=s.querySelector("#settings-body");ve(s,B=>{if(B==="save"&&z(),B==="clear-key"){if(!R)return;r=!0;const q=s.querySelector("#ai-key");q&&(q.value=""),U(R)}}),Xe(s,(B,q)=>{B!=="ai-provider"||!R||(b=q,w=!1,U(R))}),W();async function W(){try{const B=await Cn();if(i)return;R=B,U(B)}catch(B){if(i)return;A.innerHTML=`<p class="error">Failed to load settings: ${n(String(B))}</p>`}}function U(B){var C;const q=b??B.aiProvider;A.innerHTML=`
      <form class="card" id="settings-form" onsubmit="return false">
        <label>
          AI provider
          ${Ye("ai-provider",Dn.map(p=>({value:p.value,label:p.label})),q)}
        </label>
        <label>
          API key
  ...
  `;const p=s.querySelector("#rpc-body");ve(s,(e,a)=>{mt(e,a)}),Xe(s,()=>{}),$();async function $(){try{const e=await dt();if(i)return;r=e,t=null}catch(e){if(i)return;r=null,t=he(e)}J();for(const e of(r==null?void 0:r.gateways)??[])N(e.id),H(e.id,!1)}async function N(e){try{const a=await fn(e);if(i)return;f[e]=a}catch{if(i)return;f[e]=null}J()}async function H(e,a){R[e]=a,a&&J();try{const o=await bn(e,a);if(i)return;w[e]=o}catch{if(i)return;w[e]=null}R[e]=!1,J()}function G(e){return((r==null?void 0:r.gateways)??[]).find(a=>a.id===e)}function Q(e,a){return(e.networks??[]).find(o=>o.chainId===a)}function ee(e,a,o){var u;const l=(((u=f[e])==null?void 0:u.networks)??[]).find(T=>T.chainId===a);return((l==null?void 0:l.upstreams)??[]).find(T=>T.upstream===o)}function se(e,a,o){var l;return(((l=w[e])==null?void 0:l.endpoints)??[]).find(u=>u.chainId===a&&u.upstream===o)}function J(){if(i)return;if(t){p.innerHTML=`<p class="error">Could not read the gateways: ${n(t)}</p>`;return}if(!r){p.innerHTML='<p class="muted">Loading…</p>';return}const e=r.gateways??[],a=e.length>1,o=(r.targets??[]).some(l=>nt(l.id,e));p.innerHTML=`
    ...
    `}function ue(e){const a=`docker rm -f ${e.containerName}`,o=I[e.containerName];return`
      <div class="strip">
        ${pe({tone:"warn",text:`${e.containerName} is still running on ${e.targetId}. Its chains were folded into ${e.mergedInto}, but valve-node-app does not stop containers it did not start.`,cmd:a})}
    ...
    `}function fe(){return((r==null?void 0:r.targets)??[]).length===0?`
    ...
    `}function be(e){var u,T;const a=e.tls;if(!(a!=null&&a.enabled))return[];const o=[];a.fallback&&o.push({tone:"warn",text:a.fallback}),a.error?o.push({tone:"warn",text:`HTTPS front: ${a.error}`}):((u=a.status)==null?void 0:u.State)!=="running"&&o.push({tone:"warn",text:`The HTTPS front is ${((T=a.status)==null?void 0:T.State)??"unknown"}, so nothing answers on ${a.url??"its https URL"} even if the gateway itself is up.`,cmd:a.containerName?`docker start ${a.containerName}`:void 0});const l=z[e.id]??a.verification??null;return l&&(!l.ok||!l.subscriptionsOk)&&o.push({tone:l.ok?"warn":"bad",text:`${l.summary} Checked ${new Date(l.at).toLocaleString()} — open Settings for the full check.`}),l!=null&&l.expiryWarning&&o.push({tone:"warn",text:l.expiryWarning}),a.rootCaPath&&a.effectiveCertSource==="internal"&&o.push({tone:"note",text:`Served by Caddy's own certificate authority. Install this file (on ${e.placement.targetId}) into the trust store of every device that will call it and the browser warning goes away:`,cmd:a.rootCaPath}),o}function ge(e){switch(e.status.State){case"running":return O("running","ok");case"created-but-stopped":return O("stopped","warn");case"not-created":return O("not created","neutral");default:return O("unknown","bad")}}function g(e){return e.status.State==="running"?$e("ok"):e.status.State==="unknown"?$e("bad"):$e("neutral")}function d(e,a){const o=Fn[a];if(!o)return"";const l=b[e.id];return`
...
`))}</pre>
      ...
      <section class="chain chain-${l.tone}">
        <div class="chain-head">
          ...
          <span class="chain-right">
            ${F(o.length,l.tone,a.knownSetSize)}
    ...
    `}function F(e,a,o){const l=o>0,u=l?o:e,T=Math.min(e,u);let S="";for(let Pe=0;Pe<u;Pe++)S+=`<span class="seg${Pe<T?` seg-on seg-${a}`:""}"></span>`;const v=l&&e>o,_=l?v?`${e} (set is ${o})`:`${e} of ${o}`:`${e}`,Z=`${e} upstream${e===1?"":"s"} configured`,le=l?`${Z}${v?`, ${e-o} beyond the set`:""}. valve's set for this chain is ${o}.`:`${Z}. valve has not measured a set for this chain, so there is nothing to count it against.`;return`
      <span class="segs" title="${n(le)}">${S}</span>
    ...
    `}function E(e){return e.problem?O("unusable","bad"):e.recentOnly?O("recent blocks","warn"):e.local?O("yours","ok"):O("public","neutral")}function j(e,a){var o;if(e)return a==="http"?e.unprobeable?"inconclusive":e.reachable?"supported":"unsupported":(o=(e.capabilities??[]).find(l=>l.key===a))==null?void 0:o.status}function Y(e,a,o){const l=se(e.id,a.chainId,o.id);return l?l.unprobeable?`<span class="caps-none" title="${n(l.unprobeable)}">not probeable from here</span>`:`<span class="caps">${Mn.map(u=>D(e,a,l,u)).join("")}</span>`:`<span class="muted small">${w[e.id]===void 0?"probing…":"—"}</span>`}function D(e,a,o,l){const u=(o.capabilities??[]).find(Z=>Z.key===l),T=j(o,l)??"inconclusive",S=On[l]??l.toUpperCase();let v="cap";T==="unsupported"?v=te(e,a,l)?"cap missing":"cap off":T==="inconclusive"?v="cap unknown":T==="inconsistent"&&(v="cap mixed");const _=u!=null&&u.detail?`${u.label}: ${u.detail}`:l==="http"&&o.reachDetail?`Answers JSON-RPC over HTTP: ${o.reachDetail}`:`${S}: no verdict`;return`<span class="${v}" title="${n(_)}">${n(S)}</span>`}function te(e,a,o){const l=(a.upstreams??[]).map(u=>se(e.id,a.chainId,u.id)).filter(u=>!!u&&!u.unprobeable);return l.length>0&&l.every(u=>j(u,o)==="unsupported")}function X(e,a,o){const l=f[e.id];if(l===void 0)return'<span class="muted small">reading…</span>';if(l===null)return'<span class="muted small" title="The counters could not be read.">—</span>';if(!l.enabled)return`<span class="muted small" title="This gateway's request counters are turned off in its settings.">counters off</span>`;const u=ee(e.id,a.chainId,o.id),T=(l.networks??[]).find(le=>le.chainId===a.chainId);if(!u||!T||T.attributed===0)return'<span class="muted small">no traffic yet</span>';const S=Math.round(u.actual*100),v=Math.round(u.intended*100),_=u.diverged?o.local?"warn":"":"ok",Z=`${u.succeeded.toLocaleString()} of ${T.attributed.toLocaleString()} answered requests · routing intends ${v}%`+(u.unconfigured?" · this endpoint is no longer in the saved configuration":"");return`
    ...
    `}function Se(e){const a=f[e.id];return a?a.enabled?a.error?`<p class="muted small">The request counters could not be read: ${n(a.error)}</p>`:`<p class="muted small">
    ...
    `}function Me(e){var S;const a=n(e.id),o=e.config.TLS??null,l=(o==null?void 0:o.Enabled)??!1,u=(o==null?void 0:o.CertSource)||"internal",T=((S=e.tls)==null?void 0:S.suggestedHostname)??"";return`
      ...
      ${xe(e)}
    `}function xe(e){var S,v;const a=n(e.id),o=((S=e.config.TLS)==null?void 0:S.Enabled)??!1,l=z[e.id]??((v=e.tls)==null?void 0:v.verification)??null,u=B[e.id]??!1,T=q[e.id]??null;return`
      <hr />
      <div class="card-actions">
      ...
      ${l?pt(l):""}
    `}function pt(e){const a=(e.assertions??[]).map(o=>`
          <li class="small">
            ${ht(o.status)}
    ...
    `}function ht(e){switch(e){case"pass":return O("pass","ok");case"fail":return O("fail","bad");case"unavailable":return O("unavailable","warn");default:return O("skipped","neutral")}}async function ft(e){B[e]=!0,q[e]=null,J();try{z[e]=await hn(e)}catch(a){q[e]=`${he(a)}${Le(a)}`}finally{B[e]=!1,J()}}function ke(e){return{...e.config,Networks:(e.config.Networks??[]).map(a=>({ChainID:a.ChainID,Upstreams:a.Upstreams.map(o=>({...o}))}))}}async function Te(e,a,o){A[e]=null;try{await yn(e,a)}catch(l){return A[e]=`${o?o+": ":""}${he(l)}`,J(),!1}return await $(),!0}async function mt(e,a){const o=a.dataset.gid??"";switch(e){case"refresh":await $();return;case"copy":a.dataset.copy&&await qt(a,a.dataset.copy);return;case"reprobe":await H(o,!0);return;case"toggle-settings":U[o]=!U[o],J();return;case"save-settings":await bt(o);return;case"verify-tls":await ft(o);return;case"gw-start":case"gw-stop":case"gw-restart":await vt(o,e.slice(3));return;case"gw-create":case"gw-recreate":await $t(o);return;case"gw-wipe":Dt(o);return;case"add-gateway":Mt();return;case"forget-gateway":await wt(o);return;case"dismiss-orphan":await kt(a.dataset.name??"");return;case"add-chain":Tt(o);return;case"remove-chain":await Pt(o,Number.parseInt(a.dataset.chain??"",10));return;case"add-endpoint":tt(o,Number.parseInt(a.dataset.chain??"",10));return;case"remove-endpoint":await Et(a.dataset.key??"");return;case"reset-devnet":await Bt(a.dataset.key??"",a.dataset.target??"");return;default:return}}async function bt(e){const a=G(e);if(!a)return;const o=ke(a),l=s.querySelector(`#gw-${CSS.escape(e)}-port`),u=s.querySelector(`#gw-${CSS.escape(e)}-bind`);if(l){const v=Number.parseInt(l.value.trim(),10);Number.isFinite(v)&&(o.Port=v)}u&&(o.BindAddr=u.value.trim());const T=s.querySelector(`#gw-${CSS.escape(e)}-metrics`);T&&(o.MetricsOff=!T.checked),o.TLS=gt(e,a);const S=a.status.State==="running";await Te(e,o,"Saving settings")&&(U[e]=!1,S&&(A[e]=null,yt(e,"Saved. The running container still has the old port and bind — press “Re-create (apply config)” to put them into effect.")),J())}function gt(e,a){var T,S,v,_,Z,le,Pe;const o=Ft=>s.querySelector(`#gw-${CSS.escape(e)}-${Ft}`),l=o("tls");if(!l)return a.config.TLS??null;const u=Number.parseInt(((T=o("tls-port"))==null?void 0:T.value.trim())??"",10);return{Enabled:l.checked,Hostname:((S=o("tls-host"))==null?void 0:S.value.trim())??"",CertSource:((v=o("tls-source"))==null?void 0:v.value)??"internal",CertFile:((_=o("tls-cert"))==null?void 0:_.value.trim())??"",KeyFile:((Z=o("tls-key"))==null?void 0:Z.value.trim())??"",HTTPSPort:Number.isFinite(u)?u:443,BindAddr:((le=a.config.TLS)==null?void 0:le.BindAddr)??"",ImageRef:((Pe=a.config.TLS)==null?void 0:Pe.ImageRef)??""}}function yt(e,a){W[e]=[a]}async function vt(e,a){if(!b[e]){b[e]=a,A[e]=null,J();try{await vn(e,a)}catch(o){A[e]=`${a} failed: ${he(o)}${Le(o)}`}b[e]=null,await $()}}async function $t(e){if(b[e])return;b[e]="create",A[e]=null,W[e]=["starting…"],J();let a;try{a=await $n(e)}catch(o){A[e]=`${he(o)}${Le(o)}`,W[e]=[],b[e]=null,J();return}C==null||C(),C=Ze(a.targetId,o=>{if(i)return;const l=o.err?`${o.stepId}: ${o.err}`:o.line?`${o.stepId}: ${o.line}`:`${o.stepId}: done`;if(W[e]=[...(W[e]??[]).filter(T=>T!=="starting…"),l],!!o.err||o.stepId===qn&&!!o.done){C==null||C(),C=null,b[e]=null,o.err&&(A[e]="Provisioning failed — see the log below."),$();return}J()})}async function wt(e){const a=G(e);if(!(!a||!await Be({title:`Forget ${a.label}`,body:`valve-node-app will forget this gateway's configuration. Its container "${a.containerName}" on ${a.placement.targetId} is NOT touched — if it is running it keeps running and keeps serving. Stop or wipe it first if you wanted it gone.`,confirmLabel:"Forget it",danger:!0}))){try{await gn(e)}catch(l){A[e]=he(l),J();return}await $()}}async function kt(e){if(e){I[e]=null;try{await un(e)}catch(a){I[e]=he(a),J();return}await $()}}function Tt(e){const a=G(e);if(!a)return;const o=new Set((a.networks??[]).map(v=>v.chainId)),l=(r==null?void 0:r.presets)??[],u=l.filter(v=>!o.has(v.chainId)),T=l.filter(v=>o.has(v.chainId)),S=((r==null?void 0:r.targets)??[]).some(v=>v.id===a.placement.targetId&&v.hasDevnet);ne(`
        <h2>Add a network</h2>
        <p class="muted small">
      ...
      `,v=>{if(v==="cancel"){V();return}if(v==="custom"){Ct(e);return}if(v.startsWith("preset:")){const _=Number.parseInt(v.slice(7),10),Z=l.find(le=>le.chainId===_);V(),Z!=null&&Z.devnet?xt(e,_,S):Qe(e,_)}})}function Ct(e){var a;ne(`
      ...
      `,o=>{if(o==="cancel"){V();return}if(o!=="add")return;const l=document.getElementById("custom-chain-id"),u=document.getElementById("custom-chain-err"),T=Number.parseInt((l==null?void 0:l.value.trim())??"",10);if(!Number.isFinite(T)||T<=0){u&&(u.className="error small"),u&&(u.textContent="A chain id is a positive whole number.");return}V(),Qe(e,T)}),(a=document.getElementById("custom-chain-id"))==null||a.focus()}async function Qe(e,a){const o=G(e);if(!o)return;const l=ke(o),u=l.Networks??[];u.some(T=>T.ChainID===a)||(u.push({ChainID:a,Upstreams:[]}),l.Networks=u,await St(e,l)&&(J(),tt(e,a)))}async function St(e,a){var T;const o={...a,Networks:(a.Networks??[]).filter(S=>S.Upstreams.length>0)};if(!await Te(e,o))return!1;const u=G(e);if(u)for(const S of a.Networks??[])S.Upstreams.length===0&&!(u.networks??[]).some(v=>v.chainId===S.ChainID)&&(u.config.Networks=[...u.config.Networks??[],{ChainID:S.ChainID,Upstreams:[]}],u.networks=[...u.networks??[],{chainId:S.ChainID,name:((T=((r==null?void 0:r.presets)??[]).find(v=>v.chainId===S.ChainID))==null?void 0:T.name)??`Chain ${S.ChainID}`,path:`/${u.config.ProjectID}/evm/${S.ChainID}`,upstreams:[],knownSetSize:0,serviceable:!1,warnings:["This network has no endpoint yet, so it is not saved on the gateway until you add one."]}]);return!0}async function xt(e,a,o){const l=G(e);if(!l)return;if(!o){ne(`
        ...
        `,()=>V());return}const u=ke(l),T=u.Networks??[],S={ID:"devnet",Kind:"managed-devnet",TargetID:l.placement.targetId,Endpoint:"",Local:!0,RecentOnly:!1},v=T.find(_=>_.ChainID===a);v?v.Upstreams.push(S):T.push({ChainID:a,Upstreams:[S]}),u.Networks=T,await Te(e,u,"Adding the devnet")}async function Pt(e,a){const o=G(e);if(!o||!Number.isFinite(a))return;const l=Q(o,a);if(!await Be({title:`Remove ${(l==null?void 0:l.name)??`chain ${a}`}`,body:`This gateway will stop serving ${(l==null?void 0:l.path)??`chain ${a}`}. Nothing on the other end is touched — the nodes and endpoints behind it keep running.`,confirmLabel:"Remove network",danger:!0}))return;const T=ke(o);T.Networks=(T.Networks??[]).filter(S=>S.ChainID!==a),await Te(e,T,"Removing the network")}function et(e){const a=e.split("|");return a.length!==3?null:{gid:a[0],chainId:Number.parseInt(a[1],10),upstreamId:a[2]}}async function Et(e){const a=et(e);if(!a)return;const o=G(a.gid);if(!o)return;const l=ke(o),u=(l.Networks??[]).find(v=>v.ChainID===a.chainId);if(!u)return;const T=u.Upstreams.findIndex((v,_)=>(v.ID||`${a.chainId}-${_}`)===a.upstreamId);T<0||!await Be({title:"Remove this endpoint",body:"The gateway stops routing to it. Whatever is on the other end — a node, a devnet, a public endpoint — is left completely alone.",confirmLabel:"Remove",danger:!0})||(u.Upstreams.splice(T,1),await Te(a.gid,l,"Removing the endpoint"))}function tt(e,a){const o=G(e);if(!o||!Number.isFinite(a))return;const l=((r==null?void 0:r.sources)??[]).filter(v=>v.chainId===a),u=Q(o,a),T=new Set(((u==null?void 0:u.upstreams)??[]).filter(v=>v.kind!=="external").map(v=>`${v.kind}|${v.targetId??""}`)),S=l.filter(v=>!T.has(`${v.kind}|${v.targetId}`));ne(`
      ...
      `,v=>{if(v==="cancel"){V();return}if(v==="known-set"){Lt(e,a);return}if(v==="manual"){At(e,a);return}if(v.startsWith("source:")){const[,_,Z]=v.split(":");V(),It(e,a,_,Z)}})}async function It(e,a,o,l){const u=G(e);if(!u)return;const T=ke(u),S=T.Networks??[],v={ID:`${o==="managed-devnet"?"devnet":"node"}-${l}`,Kind:o,TargetID:l,Endpoint:"",Local:!0,RecentOnly:!1},_=S.find(Z=>Z.ChainID===a);_?_.Upstreams.push(v):S.push({ChainID:a,Upstreams:[v]}),T.Networks=S,await Te(e,T,"Adding the endpoint")}function Rt(e){const a=[...e].sort((u,T)=>(u.latencyMs??1e9)-(T.latencyMs??1e9)),o=a.slice(0,3),l=a.find(u=>u.url.startsWith("wss://")||u.url.startsWith("ws://"));return l&&!o.some(u=>u.url===l.url)&&(o.length===3&&o.pop(),o.push(l)),new Set(o.map(u=>u.url))}async function Lt(e,a){let o;try{o=await Tn(e,a)}catch(v){ne(`<h2>Endpoints for chain ${a}</h2>
         <p class="error small">Could not read the set: ${n(he(v))}</p>
       ...
       ${o.usingDefaultKey?`<p class="muted small">Using the shared <code>${n(o.key)}</code> key, so this works with
                ...
                There is no way to enter a key of your own from this app yet.</p>`:'<p class="muted small">Using your key for this chain.</p>'}
       <div class="modal-actions">
         <button class="btn btn-ghost" data-modal-action="cancel">Cancel</button>
      ...
      `,S=>{S==="cancel"&&V()});let o;try{o=await kn(a)}catch(S){const v=He();if(v){const _=document.createElement("p");_.className="error small",_.textContent=`Could not discover endpoints: ${he(S)}`,v.appendChild(_)}return}if(i)return;const l=(o.endpoints??[]).filter(S=>S.status==="live"||S.status==="unprobed"),u=(o.endpoints??[]).filter(S=>S.status==="rejected"),T=Rt(l);ne(`
        <h2>Public endpoints for chain ${a}</h2>
      ...
      `,S=>{if(S==="cancel"){V();return}if(S==="add"){const v=He(),_=v?Array.from(v.querySelectorAll('input[type="checkbox"]:checked')).map(Z=>Z.value):[];V(),ze(e,a,_);return}})}function At(e,a){var o;ne(`
      ...
      `,l=>{if(l==="cancel"){V();return}if(l!=="add")return;const u=document.getElementById("manual-endpoint"),T=document.getElementById("manual-recent"),S=document.getElementById("manual-err"),v=(u==null?void 0:u.value.trim())??"";if(!/^(https?|wss?):\/\//i.test(v)){S&&(S.className="error small",S.textContent="It needs a scheme eRPC can dial: http://, https://, ws:// or wss://.");return}V(),ze(e,a,[v],(T==null?void 0:T.checked)??!1)}),(o=document.getElementById("manual-endpoint"))==null||o.focus()}async function ze(e,a,o,l=!1){if(!o.length)return;const u=G(e);if(!u)return;const T=ke(u),S=T.Networks??[];let v=S.find(Z=>Z.ChainID===a);v||(v={ChainID:a,Upstreams:[]},S.push(v));let _=1;for(const Z of v.Upstreams){const le=/^public-\d+-(\d+)$/.exec(Z.ID??"");le&&(_=Math.max(_,Number(le[1])+1))}for(const Z of o)v.Upstreams.some(le=>le.Endpoint===Z)||v.Upstreams.push({ID:`public-${a}-${_++}`,Kind:"external",Endpoint:Z,Local:!1,RecentOnly:l});T.Networks=S,await Te(e,T,o.length===1?"Adding the endpoint":`Adding ${o.length} endpoints`)}async function Bt(e,a){const o=et(e);if(!o||!a||!await Be({title:"Reset this devnet",body:`The chain on ${a} starts again from genesis at block 0 — every block, transaction and account it has produced is discarded. The gateways in front of it are restarted so they stop advertising the old head.`,confirmLabel:"Reset the chain"}))return;b[o.gid]="reset",A[o.gid]=null,J();let u;try{u=await ln(a)}catch(T){A[o.gid]=`Reset failed: ${he(T)}${Le(T)}`,b[o.gid]=null,J();return}b[o.gid]=null,Ht(a,u),await $()}function Ht(e,a){const o=[];o.push(a.report.ContainerRemoved?"The old chain was removed.":"There was no devnet container to remove."),a.report.Recreated&&o.push("A fresh chain was started from genesis.");const l=a.report.Cascaded??[],u=a.report.CascadeSkipped??[];ne(`
      ...
      `,u=>{if(u==="cancel"||u==="close"){V(),$();return}u==="confirm"&&Ut(e)});const o=document.getElementById("wipe-confirm-input"),l=document.getElementById("wipe-confirm-btn");o==null||o.addEventListener("input",()=>{l&&(l.disabled=o.value.trim()!==e)}),o==null||o.focus()}async function Ut(e){const a=document.getElementById("wipe-confirm-btn");a&&(a.disabled=!0,a.textContent="Wiping…");let o;try{o=await wn(e)}catch(l){const u=He();if(u){const T=document.createElement("p");T.className="error small",T.textContent=`Wipe failed: ${he(l)}${Le(l)}`,u.appendChild(T)}a&&(a.disabled=!1,a.textContent=`Wipe ${e}`);return}ne(`
        <h2>${n(e)} wiped</h2>
        <ul class="plain-list">
        ...
        <div class="modal-actions"><button class="btn" data-modal-action="close">Close</button></div>
      `,()=>{V(),$()})}function nt(e,a){return!a.some(o=>{var l;return((l=o.placement)==null?void 0:l.targetId)===e})}function Mt(){var T;const e=(r==null?void 0:r.targets)??[],a=(r==null?void 0:r.gateways)??[],o=e.filter(S=>nt(S.id,a)),l=new Set(a.map(S=>S.id));if(e.length===0){ne(`
    ...
    ${ie()}
  `;const q=s.querySelector("#services-body");ve(s,(c,m)=>{ge(c,m)}),I();async function I(){try{const c=await sn(i);if(r)return;t=c,f=null}catch(c){if(r)return;t=null,f=x(c)}p()}function C(c){return t==null?void 0:t.services.find(m=>m.id===c)}function p(){if(!r){if(f){q.innerHTML=`<p class="error">Could not read this machine's services: ${n(f)}</p>`;return}if(!t){q.innerHTML='<p class="muted">Loading…</p>';return}q.innerHTML=`
      ${$(t.docker)}
...
`))}</pre>
    ...
    `}function ue(c){const m=W[c.id],E=fe(c);return`
      <div class="config-block">
        <div class="service-head">
    ...
    `}function fe(c){const m=c.devnet;return m?`Chain ${m.ChainID} · a block every ${n(m.BlockTime)} · JSON-RPC on ${n(m.BindAddr)}:${m.HTTPPort} · WebSocket on ${n(m.BindAddr)}:${m.WSPort}`:"—"}function ce(c){return oe()}function oe(){const c=U;return c?`
      <label>
    ...
    `:""}function re(){W.devnet&&U&&(U.BlockTime=pe("#dev-blocktime",U.BlockTime),U.HTTPPort=be("#dev-http",U.HTTPPort),U.WSPort=be("#dev-ws",U.WSPort),U.BindAddr=pe("#dev-bind",U.BindAddr))}function pe(c,m){const E=s.querySelector(c);return E?E.value.trim():m}function be(c,m){const E=s.querySelector(c);if(!E)return m;const j=Number.parseInt(E.value.trim(),10);return Number.isFinite(j)?j:m}async function ge(c,m){const E=m.dataset.svc??"";switch(c){case"refresh":await I();return;case"copy":m.dataset.copy&&await y(m,m.dataset.copy);return;case"svc-start":case"svc-stop":case"svc-restart":await g(E,c.slice(4));return;case"svc-create":case"svc-recreate":await d(E);return;case"svc-wipe":L(E);return;case"toggle-config":k(E);return;case"save-config":await P(E);return;default:return}}async function g(c,m){if(!w[c]){w[c]=m,R[c]=null,p();try{await on(i,c,m)}catch(E){R[c]=`${m} failed: ${x(E)}${M(E)}`}w[c]=null,await I()}}async function d(c){if(!w[c]){w[c]="create",R[c]=null,b[c]=["starting…"],p();try{await cn(i,c)}catch(m){R[c]=`${x(m)}${M(m)}`,b[c]=[],w[c]=null,p();return}A==null||A(),A=Ze(i,m=>{if(r)return;const E=m.err?`${m.stepId}: ${m.err}`:m.line?`${m.stepId}: ${m.line}`:`${m.stepId}: done`;if(b[c]=[...(b[c]??[]).filter(Y=>Y!=="starting…"),E],!!m.err||m.stepId===Wn&&!!m.done){A==null||A(),A=null,w[c]=null,m.err&&(R[c]="Provisioning failed — see the log below."),I();return}p()})}}function k(c){if(re(),W[c]=!W[c],z[c]=null,B[c]=null,W[c]){const m=C(c);m!=null&&m.devnet&&(U={...m.devnet})}p()}async function P(c){var j;re(),z[c]=null,B[c]=null;const m=U;if(!m)return;if(m.HTTPPort===m.WSPort){z[c]="JSON-RPC and WebSocket cannot share a port — docker would accept both mappings and then fail to start the container.",p();return}try{await dn(i,c,m)}catch(Y){z[c]=x(Y),p();return}const E=((j=C(c))==null?void 0:j.status.State)==="running";W[c]=!1,B[c]=E?"Saved. The running container still has the old settings — press “Re-create (apply config)” to put them into effect.":"Saved.",await I()}function L(c){const m=C(c);if(!m)return;const E=(m.restartsOnWipe??[]).map(D=>{var te;return((te=C(D))==null?void 0:te.label)??D});ne(`
      ...
      `,D=>{if(D==="cancel"||D==="close"){V(),I();return}D==="confirm"&&F(c)});const j=document.getElementById("wipe-confirm-input"),Y=document.getElementById("wipe-confirm-btn");j==null||j.addEventListener("input",()=>{Y&&(Y.disabled=j.value.trim()!==c)}),j==null||j.focus()}async function F(c){const m=document.getElementById("wipe-confirm-btn");m&&(m.disabled=!0,m.textContent="Wiping…");let E;try{E=await rn(i,c)}catch(j){const Y=He();if(Y){const D=document.createElement("p");D.className="error small",D.textContent=`Wipe failed: ${x(j)}${M(j)}`,Y.appendChild(D)}m&&(m.disabled=!1,m.textContent=`Wipe ${c}`);return}h(c,E)}function h(c,m){const E=C(c),j=X=>{var Se;return((Se=C(X))==null?void 0:Se.label)??X},Y=[];Y.push(m.report.ContainerRemoved?"Container removed.":"There was no container to remove.");for(const X of m.report.VolumesRemoved??[])Y.push(`Volume ${X} deleted.`);for(const X of m.report.VolumesAbsent??[])Y.push(`Volume ${X} was already gone.`);m.report.Recreated&&Y.push("Container re-created from your saved configuration.");const D=(m.report.Cascaded??[]).map(j),te=(m.report.CascadeSkipped??[]).map(j);ne(`
  ...
  `;const w=s.querySelector("#targets-body");ve(s,(p,$)=>{U(p,$)}),R();async function R(){try{const[p,$,N]=await Promise.all([Ie(),Ee(),_t()]);if(i)return;t=N.os,A(p,$)}catch(p){if(i)return;w.innerHTML=`<p class="error">Failed to load machines: ${n(String(p))}</p>`}}function b(){f&&A(f.targets,f.catalog)}function A(p,$){f={targets:p,catalog:$};const N=t==="linux",H=[...p].sort((ee,se)=>(ee.mode==="local"?-1:0)-(se.mode==="local"?-1:0)),G=H.length?`<div class="card-grid">${H.map(ee=>Vn(ee,$,ee.mode!=="local"||N,t)).join("")}</div>`:'<div class="card empty-state"><p class="muted">No machines yet — pick an option below.</p></div>',Q=p.some(ee=>ee.mode==="local");w.innerHTML=`
    ...
    `,H=p?`
      ...
      `;return $?`<div class="card-grid card-grid-wide">${N}</div>`:`<div class="card-grid card-grid-wide">${p?H+N:N+H}</div>`}async function U(p,$){var N;if(p==="add-local"){await z();return}if(p==="delete-target"){const H=$.dataset.id;if(!H||!await Be({title:"Remove machine",body:`Remove "${H}"? This only removes it from valve-node-app — anything already running on the machine keeps running, and its data is left alone.`,confirmLabel:"Remove",danger:!0}))return;await B(H);return}if(p==="toggle-ssh"){r=!r,C(),b(),r&&((N=s.querySelector("#ssh-host"))==null||N.focus());return}p==="add-ssh"&&await q()}async function z(){C();try{await at({id:Gn,mode:"local"}),await R()}catch(p){I(p)}}async function B(p){try{await Kt(p),await R()}catch($){I($)}}async function q(){const p=s.querySelector("#ssh-host"),$=s.querySelector("#ssh-user"),N=s.querySelector("#ssh-key"),H=s.querySelector("#ssh-port"),G=s.querySelector("#ssh-id");if(!p||!$||!N||!H||!G)return;const Q=p.value.trim(),ee=$.value.trim(),se=N.value.trim(),J=H.value.trim(),ue=G.value.trim();if(C(),!Q||!ee||!se){I(new Error("host, user, and key path are required"));return}const fe=ue||Zn(Q),ce={Host:Q,User:ee,KeyPath:se};if(J){const re=Number.parseInt(J,10);if(!Number.isFinite(re)||re<=0){I(new Error("port must be a positive number"));return}ce.Port=re}const oe=s.querySelector("#ssh-submit");oe&&(oe.disabled=!0,oe.textContent="Connecting…");try{await at({id:fe,mode:"ssh",ssh:ce}),r=!1,await R()}catch(re){I(re),oe&&(oe.disabled=!1,oe.textContent="Add server")}}function I(p){let $=s.querySelector("#targets-error");$||(w.insertAdjacentHTML("afterbegin",'<p id="targets-error" class="error"></p>'),$=s.querySelector("#targets-error")),$.textContent=String(p instanceof Error?p.message:p)}function C(){var p;(p=s.querySelector("#targets-error"))==null||p.remove()}return()=>{i=!0}}function Vn(s,i,r,t){const f=s.wire,w=s.mode==="local"?"this machine":"SSH",R=s.mode==="ssh"&&s.ssh?`${n(s.ssh.User)}@${n(s.ssh.Host)}`:w,b=`<a class="btn btn-ghost" href="#/services/${encodeURIComponent(s.id)}">Devnet</a>`;let A,W;if(!f&&!r)A=`${O("can't run a node","warn")} ${O(t||"not Linux","neutral")}`,W=`
      ${b}
    ...
    `;else if(!f)A=O("not set up","neutral"),W=`
      ...
      ${b}
    `;else{const U=i.networks.find(B=>B.ChainID===f.ChainID),z=U?U.Name:`chain ${f.ChainID}`;A=`${O(z,"ok")} ${O(f.ExecID,"neutral")} ${O(f.BeaconID,"neutral")}${f.Archive?" "+O("archive","warn"):""}`,W=`
  ...
  `}function Zn(s){return s.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")||"target"}const Ve=[{id:"preflight",title:"Preflight checks"},{id:"toolchain",title:"Ensure git + build toolchains"},{id:"install-exec",title:"Install execution client"},{id:"install-beacon",title:"Install beacon client"},{id:"wire",title:"Write JWT secret and systemd units"},{id:"start",title:"Start execution and beacon services"},{id:"handshake",title:"Verify execution/beacon handshake"}],qe=8545,Fe=5052,je=30303,Xn=[369,943,1],lt={369:"default",943:"practise here first"};function Qn(s,i){let r=!1;const t={targetId:i,step:"network",catalog:null,loadError:null,chainId:369,execId:null,beaconId:null,archive:!0,dataDir:"",jwtPath:"",execHTTPPort:"",beaconHTTPPort:"",execP2PPort:"",execHTTPPortError:null,beaconHTTPPortError:null,execP2PPortError:null,rpcBindAddr:"",rpcBindAddrError:null,freeBytes:null,probedPath:null,diskProbing:!1,diskError:null,downgradeNote:null,checkpoint:!0,checkpointUrl:"",checkpointUrlError:null,execSnapshot:!1,snapshotKey:"",snapshotKeyError:null,starting:!1,startError:null,events:[],streamStop:null};s.innerHTML=`<h1>Setup: ${n(i)}</h1><div id="wizard-body"><p class="muted">Loading catalog…</p></div><div id="wizard-footer">${ie()}</div>`;const f=s.querySelector("#wizard-body"),w=s.querySelector("#wizard-footer");ve(s,(h,y)=>{be(h,y)}),Xe(s,(h,y)=>{h==="exec-select"?t.execId=y:h==="beacon-select"&&(t.beaconId=y),b()}),s.addEventListener("change",h=>{const y=h.target;y instanceof HTMLInputElement&&(y.id==="data-dir-input"?(ge(),se()):y.id==="checkpoint-toggle"?(t.checkpoint=y.checked,b()):y.id==="exec-snapshot-toggle"&&(t.execSnapshot=y.checked,b()))}),R();async function R(){try{const[h,y]=await Promise.all([Ee(),Ie()]);if(r)return;t.catalog=h;const x=y.find(M=>M.id===i);x!=null&&x.wire&&(t.chainId=x.wire.ChainID,t.execId=x.wire.ExecID,t.beaconId=x.wire.BeaconID,t.archive=x.wire.Archive,x.wire.ExecHTTPPort&&(t.execHTTPPort=String(x.wire.ExecHTTPPort)),x.wire.BeaconHTTPPort&&(t.beaconHTTPPort=String(x.wire.BeaconHTTPPort)),x.wire.ExecP2PPort&&(t.execP2PPort=String(x.wire.ExecP2PPort)),x.wire.RPCBindAddr&&(t.rpcBindAddr=x.wire.RPCBindAddr)),b()}catch(h){if(r)return;t.loadError=String(h instanceof Error?h.message:h),b()}}function b(){if(t.loadError){f.innerHTML=`<p class="error">Failed to load: ${n(t.loadError)}</p>`;return}t.catalog&&(f.innerHTML=`
    ...
    `}function B(h){return h<=0?"—":h>=1?`~${h.toFixed(1)} TB`:`~${Math.round(h*1e3)} GB`}const q=1.1,I=.5,C="Valve reth snapshot",p="rough estimate";function $(h){return h.SnapshotSizeTB}function N(h){return h.SnapshotSizeTB*I}function H(h){return`<p class="muted small">${B($(h))} is the measured size of Valve's reth snapshot for ${n(h.Name)}, at the block height it was cut. The full-tier figure is a rough estimate derived from it, not a measurement, and neither figure is client-specific — go-pulse, erigon-pulse and geth store the chain differently. Treat both as a sanity check on disk size, not a promise.</p>`}function G(h){return{archive:$(h)*1e12*q,full:N(h)*1e12*q}}function Q(h,y){if(!h)return"";if(t.diskProbing)return`<p class="muted small">Checking free space at <code>${n(y)}</code>…</p>`;if(t.diskError)return`<p class="error small">Couldn't read free space at <code>${n(y)}</code>: ${n(t.diskError)}</p>`;if(t.freeBytes===null||t.probedPath!==y)return"";const x=G(h),M=t.freeBytes>=x.archive,c=t.freeBytes>=x.full,m=`<p class="muted small">Free at <code>${n(y)}</code>: <strong>${Ce(t.freeBytes)}</strong> — archive ${M?"fits":"won't fit"} (${B($(h))}, ${C}), full ${c?"fits":"won't fit"} (${B(N(h))}, ${p}).</p>`;let E="";return t.downgradeNote?E=`<p class="banner banner-warn">${n(t.downgradeNote)}</p>`:c||(E=`<p class="banner banner-warn">Neither full (${B(N(h))}, ${p}) nor archive (${B($(h))}, ${C}) fits the free space here — choose a location with more room.</p>`),m+E}function ee(h,y){if(t.downgradeNote=null,!h||t.freeBytes===null)return;const x=G(h);t.archive&&t.freeBytes<x.archive&&t.freeBytes>=x.full&&(t.archive=!1,t.downgradeNote=`Not enough space at ${y} for archive (${B($(h))}, ${C}) — switched to Full (${B(N(h))}, ${p}). Pick a location with more room to run archive.`)}async function se(){var x;if(t.chainId===null)return;const h=(x=t.catalog)==null?void 0:x.networks.find(M=>M.ChainID===t.chainId),y=(t.dataDir||`/var/lib/valve-node-app/${t.chainId}`).trim();t.diskProbing=!0,t.diskError=null,b();try{const{freeBytes:M}=await zt(t.targetId,y);if(r)return;t.freeBytes=M,t.probedPath=y,ee(h,y)}catch(M){if(r)return;t.freeBytes=null,t.probedPath=y,t.diskError=String(M instanceof Error?M.message:M)}t.diskProbing=!1,b()}function J(h){return h?/^https?:\/\/.+/i.test(h)?null:"Enter an http(s) URL, or leave blank for the network default.":null}function ue(h,y){const x=y.clients.find(M=>M.id===h);return{value:h,label:x?`${x.id} — ${fe(x.repo)}`:h}}function fe(h){const y=h.split("/");return y.length>=4?y[3]:h}function ce(h,y){const x=h?y.clients.find(c=>c.id===h):void 0;if(!x)return"";const M=x.repo.replace(/^https?:\/\//,"");return`<p class="muted small">Source: <a href="${n(x.repo)}" target="_blank" rel="noopener noreferrer">${n(M)}</a></p>`}function oe(){var j,Y,D;const h=t.chainId!==null?`/var/lib/valve-node-app/${t.chainId}`:"",y=(j=t.catalog)==null?void 0:j.networks.find(te=>te.ChainID===t.chainId),x=((D=(Y=t.catalog)==null?void 0:Y.clients.find(te=>te.id===t.execId))==null?void 0:D.snapshotSupported)??!1,M=y?`${B(N(y))} (${p})`:"Smaller",c=y?`${B($(y))} (${C})`:"Much larger",m=y?` on ${n(y.Name)}`:"",E=y?t.checkpoint?y.SyncLabel:y.GenesisSyncLabel:"";return`
      <section>
    ...
    `}function pe(){const y=t.catalog.networks.find(D=>D.ChainID===t.chainId),x=y==null?void 0:y.LearnURL,M=new Set(t.events.filter(D=>D.done).map(D=>D.stepId)),c=new Set(t.events.filter(D=>D.err).map(D=>D.stepId)),m=new Map;for(const D of t.events){if(!D.line)continue;const te=m.get(D.stepId)??[];te.push(D.line),m.set(D.stepId,te)}const E=Ve.map(D=>{var Me;const te=M.has(D.id),X=c.has(D.id),Se=X?O("failed","bad"):te?O("done","ok"):O("pending","neutral"),Re=(m.get(D.id)??[]).slice(-5),Ue=(Me=t.events.find(xe=>xe.stepId===D.id&&xe.err))==null?void 0:Me.err,Ke=D.id==="handshake"?`<p class="muted small">"Talking" means the beacon client can reach the execution client's Engine API over the shared JWT secret and both report the same head — the sign your node is wired correctly.${x?` <a href="${n(x)}" target="_blank" rel="noopener noreferrer">Learn more →</a>`:""}</p>`:"";return`
