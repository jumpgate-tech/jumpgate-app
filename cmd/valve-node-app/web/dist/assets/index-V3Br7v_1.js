var Le=Object.defineProperty;var Ie=(t,r,n)=>r in t?Le(t,r,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[r]=n;var ve=(t,r,n)=>Ie(t,typeof r!="symbol"?r+"":r,n);(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const p of document.querySelectorAll('link[rel="modulepreload"]'))e(p);new MutationObserver(p=>{for(const h of p)if(h.type==="childList")for(const y of h.addedNodes)y.tagName==="LINK"&&y.rel==="modulepreload"&&e(y)}).observe(document,{childList:!0,subtree:!0});function n(p){const h={};return p.integrity&&(h.integrity=p.integrity),p.referrerPolicy&&(h.referrerPolicy=p.referrerPolicy),p.crossOrigin==="use-credentials"?h.credentials="include":p.crossOrigin==="anonymous"?h.credentials="omit":h.credentials="same-origin",h}function e(p){if(p.ep)return;p.ep=!0;const h=n(p);fetch(p.href,h)}})();function Be(){return H("/api/host")}function Y(){return H("/api/catalog")}function V(){return H("/api/targets")}function be(t){return H("/api/targets",{method:"POST",headers:te,body:JSON.stringify(t)})}function He(t){return H(`/api/targets/${encodeURIComponent(t)}`,{method:"DELETE"})}function Re(t,r){return H(`/api/targets/${encodeURIComponent(t)}/disk?path=${encodeURIComponent(r)}`)}function Ae(t,r){return H(`/api/targets/${encodeURIComponent(t)}/setup`,{method:"POST",headers:te,body:JSON.stringify(r)})}function De(t,r){const n=new EventSource(`/api/targets/${encodeURIComponent(t)}/setup/stream`);return n.onmessage=e=>{try{r(JSON.parse(e.data))}catch{}},()=>n.close()}function Ue(t,r){const n=new EventSource(`/api/targets/${encodeURIComponent(t)}/monitor/stream`);return n.onmessage=e=>{try{r(JSON.parse(e.data))}catch{}},()=>n.close()}function Ne(t,r=200){return H(`/api/targets/${encodeURIComponent(t)}/logs?n=${r}`)}function Me(t,r){const n=new EventSource(`/api/targets/${encodeURIComponent(t)}/logs/stream`);return n.onmessage=e=>{try{r(JSON.parse(e.data))}catch{}},()=>n.close()}function ye(t,r){const n=r===void 0?{}:{lines:r};return H(`/api/targets/${encodeURIComponent(t)}/explain`,{method:"POST",headers:te,body:JSON.stringify(n)})}function qe(t,r,n){return H(`/api/targets/${encodeURIComponent(t)}/services/${r}/${n}`,{method:"POST"})}function Fe(t,r){return H(`/api/targets/${encodeURIComponent(t)}/services/${r}/clear`,{method:"POST",headers:te,body:JSON.stringify({Confirm:r})})}function Oe(t){return H(`/api/targets/${encodeURIComponent(t)}/du`)}function je(t){return H(`/api/targets/${encodeURIComponent(t)}/endpoints`)}function ze(t){return H(`/api/targets/${encodeURIComponent(t)}/firewall`)}function _e(t){return H(`/api/targets/${encodeURIComponent(t)}/diagnostics`)}function We(t){return H(`/api/targets/${encodeURIComponent(t)}/diagnostics/latest`)}function Je(){return H("/api/settings")}function Ke(t){return H("/api/settings",{method:"PUT",headers:te,body:JSON.stringify(t)})}class ue extends Error{constructor(n,e){super(e);ve(this,"status");this.name="ApiError",this.status=n}}const te={"Content-Type":"application/json"};async function H(t,r){const n=await fetch(t,r);if(!n.ok){let p=n.statusText||`HTTP ${n.status}`;try{const h=await n.json();h&&typeof h.error=="string"&&h.error&&(p=h.error)}catch{}throw new ue(n.status,p)}if(n.status===204)return;const e=await n.text();return e?JSON.parse(e):void 0}const $e="https://learn.valve.city/rpc";function s(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function D(t,r){const n=t&&r&&r!==$e?` <span class="footer-sep">·</span> <a href="${s(r)}" target="_blank" rel="noopener noreferrer">${s(t)}</a>`:"";return`
  ...
  `}function ee(t){t.querySelectorAll(".dropdown.open").forEach(r=>{var n;r.classList.remove("open"),(n=r.querySelector(".dropdown-trigger"))==null||n.setAttribute("aria-expanded","false")})}function Se(t,r){t.addEventListener("click",p=>{const h=p.target,y=h.closest(".dropdown-trigger");if(y&&t.contains(y)){const S=y.closest(".dropdown"),C=!!S&&!S.classList.contains("open");ee(t),S&&C&&(S.classList.add("open"),y.setAttribute("aria-expanded","true"));return}const v=h.closest(".dropdown-option");if(v&&t.contains(v)){const S=v.closest(".dropdown");ee(t),r((S==null?void 0:S.dataset.dropdown)??"",v.dataset.value??"");return}ee(t)});const n=p=>{if(!t.isConnected){document.removeEventListener("click",n),document.removeEventListener("keydown",e);return}const h=p.target;(!h.closest(".dropdown")||!t.contains(h))&&ee(t)},e=p=>{if(!t.isConnected){document.removeEventListener("click",n),document.removeEventListener("keydown",e);return}p.key==="Escape"&&ee(t)};document.addEventListener("click",n),document.addEventListener("keydown",e)}const Xe=85,ce={exec:"Execution",beacon:"Beacon"};function Ze(t,r){let n=!1,e=null,p=null,h=null,y=null,v=null,S=null,C=null,E=null;const L={exec:null,beacon:null};let w=null;t.innerHTML=`<h1>Dashboard: ${s(r)}</h1><div id="dash-body"><p class="muted">Loading…</p></div><div id="dash-footer">${D()}</div>`;const x=t.querySelector("#dash-body"),b=t.querySelector("#dash-footer");x.addEventListener("click",a=>{const d=a.target.closest("[data-action]");if(!d||!x.contains(d))return;const g=d.dataset.action;if(g==="svc-action"){const f=d.dataset.svc,P=d.dataset.kind;f&&P&&z(f,P)}else if(g==="open-clear"){const f=d.dataset.svc;f&&ie(f)}else if(g==="copy"){const f=d.dataset.copy;f&&oe(d,f)}else g==="retry-du"?c():g==="retry-endpoints"&&u()}),l();async function l(){let a,d;try{const[f,P]=await Promise.all([V(),Y()]);a=f.find(I=>I.id===r),d=P}catch(f){if(n)return;x.innerHTML=`<p class="error">Failed to load target: ${s(String(f))}</p>`;return}if(n)return;if(!a){x.innerHTML=`<p class="error">Target "${s(r)}" not found. <a href="#/targets">Back to targets</a></p>`;return}if(!a.wire){x.innerHTML=`<p class="muted">This target hasn't completed setup yet. <a href="#/setup/${encodeURIComponent(r)}">Run the setup wizard →</a></p>`;return}const g=d==null?void 0:d.networks.find(f=>f.ChainID===a.wire.ChainID);g&&(b.innerHTML=D(g.Name,g.LearnURL)),x.innerHTML='<p class="muted">Connecting…</p>',e=Ue(r,f=>{n||($(f),p=f,h=f,k())}),c(),u()}async function c(){S=null;try{v=await Oe(r)}catch(a){v=null,S=String(a instanceof Error?a.message:a)}n||k()}async function u(){E=null;try{C=await je(r)}catch(a){C=null,E=String(a instanceof Error?a.message:a)}n||k()}function $(a){if(!p)return;const d=(new Date(a.at).getTime()-new Date(p.at).getTime())/1e3,g=a.execHead-p.execHead;if(d>0&&g>=0){const f=g/d;y=y===null?f:y*.7+f*.3}}function k(){if(!h)return;const a=h;x.innerHTML=`
    ...
    `}function Q(a){if(S)return`
        <div class="card card-warn">
          <h3>Storage</h3>
          <p class="error small">${s(S)}</p>
          <button class="btn btn-ghost" data-action="retry-du">Retry</button>
        </div>
      `;if(!v)return'<div class="card"><h3>Storage</h3><p class="muted">Loading…</p></div>';const d=v.ExpectedExecBytes>0?Math.min(v.ExecBytes/v.ExpectedExecBytes*100,100):0,g=v.ExpectedBeaconBytes>0?Math.min(v.BeaconBytes/v.ExpectedBeaconBytes*100,100):0,{lag:f,eta:P}=R(a),I=f!==null&&f>0&&y!==null&&y>0;return`
      <div class="card">
        <h3>Storage</h3>
        <p class="muted small">Estimate — varies by client and pruning.</p>
        <p class="muted small">Execution — ${K(v.ExecBytes)} of ~${K(v.ExpectedExecBytes)}</p>
        <div class="meter"><div class="meter-fill" style="width:${d}%"></div></div>
        ${I?`<p class="muted small">Estimated time remaining: ${s(P)}</p>`:""}
        <p class="muted small">Beacon — ${K(v.BeaconBytes)} of ~${K(v.ExpectedBeaconBytes)}</p>
        <div class="meter"><div class="meter-fill" style="width:${g}%"></div></div>
        <dl class="stat-list">
          <div><dt>Disk free</dt><dd>${K(v.DiskFreeBytes)}</dd></div>
          <div><dt>Sync (snapshot)</dt><dd>${s(v.SyncLabel)}</dd></div>
          <div><dt>Sync (genesis)</dt><dd>${s(v.GenesisSyncLabel)}</dd></div>
        </dl>
      </div>
    `}function _(){if(E)return`
        <div class="card card-warn">
          <h3>Endpoints</h3>
  ...
  `;const h=t.querySelector("#logs-body"),y=t.querySelector("#logs-footer");X(t,l=>{l==="explain"&&E()}),v();async function v(){let l,c;try{const[$,k]=await Promise.all([V(),Y()]);l=$.find(R=>R.id===r),c=k}catch($){if(n)return;h.innerHTML=`<p class="error">Failed to load target: ${s(String($))}</p>`;return}if(n)return;if(!l){h.innerHTML=`<p class="error">Target "${s(r)}" not found. <a href="#/targets">Back to targets</a></p>`;return}if(!l.wire){h.innerHTML=`<p class="muted">This target hasn't completed setup yet. <a href="#/setup/${encodeURIComponent(r)}">Run the setup wizard →</a></p>`;return}const u=c==null?void 0:c.networks.find($=>$.ChainID===l.wire.ChainID);u&&(y.innerHTML=D(u.Name,u.LearnURL));try{const $=await Ne(r,200);if(n)return;p.push(...$)}catch($){if(n)return;h.innerHTML=`<p class="error">Failed to load logs: ${s(String($))}</p>`;return}S(),e=Me(r,$=>{n||(p.push($),p.length>xe&&p.splice(0,p.length-xe),S())})}function S(){const l=p.filter(u=>u.severity==="error"||u.severity==="critical");h.innerHTML=`
    ...
    `}async function E(){const l=p.filter(u=>u.severity==="error"||u.severity==="critical").map(u=>u.line).slice(-40);if(!(localStorage.getItem(Pe)==="1")){L(l);return}await w(l)}function L(l){const c=l.length?`<pre class="explain-excerpt">${l.map(u=>s(u)).join(`
`)}</pre>`:'<p class="muted">No recent error lines are loaded yet — the server will auto-select its own recent error/critical lines instead.</p>';x(`
    ...
    `,u=>{u==="proceed"?(localStorage.setItem(Pe,"1"),b(),w(l)):b()})}async function w(l){x('<h2>Explain with AI</h2><p class="muted">Asking the AI provider…</p>',()=>{});try{const c=l.length?await ye(r,l):await ye(r);if(n)return;x(`
        <h2>Explanation</h2>
...
`)||"(no log lines — general question only)"}</pre>
      ...
      `,u=>{u==="close"&&b()})}catch(c){if(n)return;if(c instanceof ue&&c.status===409){x(`
          <h2>No AI provider configured</h2>
          <p>Set a provider and key in <a href="#/settings">Settings</a>, then try again.</p>
          <div class="modal-actions"><button class="btn" data-modal-action="close">Close</button></div>
        `,u=>{u==="close"&&b()});return}x(`
        <h2>Explain failed</h2>
        <p class="error">${s(c instanceof Error?c.message:String(c))}</p>
        <div class="modal-actions"><button class="btn" data-modal-action="close">Close</button></div>
      `,u=>{u==="close"&&b()})}}function x(l,c){b();const u=document.createElement("div");u.className="modal-overlay",u.id="explain-modal",u.innerHTML=`<div class="modal">${l}</div>`,u.addEventListener("click",$=>{const k=$.target.closest("[data-modal-action]");k!=null&&k.dataset.modalAction&&c(k.dataset.modalAction),$.target===u&&c("cancel")}),document.body.appendChild(u)}function b(){var l;(l=document.getElementById("explain-modal"))==null||l.remove()}return()=>{n=!0,e==null||e(),b()}}function et(t,r){let n=!1,e=null,p=null,h=!1,y=!1;t.innerHTML=`<h1>Network diagnostics: ${s(r)}</h1><div id="diag-body"><p class="muted">Loading…</p></div><div id="diag-footer">${D()}</div>`;const v=t.querySelector("#diag-body"),S=t.querySelector("#diag-footer");X(t,(c,u)=>{var $;if(c==="run")E();else if(c==="toggle")($=u.closest(".check-item"))==null||$.classList.toggle("expanded");else if(c==="copy"){const k=u.dataset.copy;k&&l(u,k)}}),C();async function C(){let c,u;try{const[k,R]=await Promise.all([V(),Y()]);c=k.find(U=>U.id===r),u=R}catch(k){if(n)return;v.innerHTML=`<p class="error">Failed to load target: ${s(String(k))}</p>`;return}if(n)return;if(!c){v.innerHTML=`<p class="error">Target "${s(r)}" not found. <a href="#/targets">Back to targets</a></p>`;return}if(!c.wire){v.innerHTML=`<p class="muted">This target hasn't completed setup yet. <a href="#/setup/${encodeURIComponent(r)}">Run the setup wizard →</a></p>`;return}const $=u==null?void 0:u.networks.find(k=>k.ChainID===c.wire.ChainID);$&&(S.innerHTML=D($.Name,$.LearnURL));try{e=await We(r),y=!0}catch(k){p=String(k instanceof Error?k.message:k)}n||L()}async function E(){h=!0,p=null,L();try{e=await _e(r),y=!0}catch(c){p=String(c instanceof Error?c.message:c)}h=!1,n||L()}function L(){v.innerHTML=`
    ...
    `}function x(c){var u;return((u=e==null?void 0:e.items.find($=>$.ID===c))==null?void 0:u.Title)??c}function b(c){const u=c.Status==="pass"?"ok":c.Status==="fail"?"bad":c.Status==="warn"?"warn":"neutral",$=c.ID===(e==null?void 0:e.failedId);return`
    ...
    `}async function l(c,u){const $=await pe(u),k=c.textContent;c.textContent=$?"Copied!":"Copy failed",setTimeout(()=>{n||(c.textContent=k)},1500)}return()=>{n=!0}}function tt(t,r){let n=!1,e=[],p=null,h=!1,y=!1;t.innerHTML=`<h1>Security: ${s(r)}</h1><div id="sec-body"><p class="muted">Loading…</p></div><div id="sec-footer">${D()}</div>`;const v=t.querySelector("#sec-body"),S=t.querySelector("#sec-footer");X(t,(b,l)=>{var c;if(b==="rerun")E();else if(b==="toggle")(c=l.closest(".check-item"))==null||c.classList.toggle("expanded");else if(b==="copy"){const u=l.dataset.copy;u&&x(l,u)}}),C();async function C(){let b,l;try{const[u,$]=await Promise.all([V(),Y()]);b=u.find(k=>k.id===r),l=$}catch(u){if(n)return;v.innerHTML=`<p class="error">Failed to load target: ${s(String(u))}</p>`;return}if(n)return;if(!b){v.innerHTML=`<p class="error">Target "${s(r)}" not found. <a href="#/targets">Back to targets</a></p>`;return}if(!b.wire){v.innerHTML=`<p class="muted">This target hasn't completed setup yet. <a href="#/setup/${encodeURIComponent(r)}">Run the setup wizard →</a></p>`;return}const c=l==null?void 0:l.networks.find(u=>u.ChainID===b.wire.ChainID);c&&(S.innerHTML=D(c.Name,c.LearnURL)),await E()}async function E(){h=!0,p=null,L();try{e=await ze(r),y=!0}catch(b){p=String(b instanceof Error?b.message:b)}h=!1,n||L()}function L(){v.innerHTML=`
      <p><a href="#/dash/${encodeURIComponent(r)}">← Back to dashboard</a></p>
      <div class="section-head">
        <p class="muted small">
    ...
    `}async function x(b,l){const c=await pe(l),u=b.textContent;b.textContent=c?"Copied!":"Copy failed",setTimeout(()=>{n||(b.textContent=u)},1500)}return()=>{n=!0}}const nt=[{value:"",label:"None"},{value:"gemini",label:"Gemini"},{value:"groq",label:"Groq"},{value:"ollama",label:"Ollama"}];function rt(t){let r=!1,n=!1,e=!1,p=null,h=!1,y=null,v=null;t.innerHTML=`<h1>Settings</h1><div id="settings-body"><p class="muted">Loading…</p></div>${D()}`;const S=t.querySelector("#settings-body");X(t,w=>{if(w==="save"&&L(),w==="clear-key"){if(!y)return;n=!0;const x=t.querySelector("#ai-key");x&&(x.value=""),E(y)}}),Se(t,(w,x)=>{w!=="ai-provider"||!y||(v=x,h=!1,E(y))}),C();async function C(){try{const w=await Je();if(r)return;y=w,E(w)}catch(w){if(r)return;S.innerHTML=`<p class="error">Failed to load settings: ${s(String(w))}</p>`}}function E(w){var l;const x=v??w.aiProvider;S.innerHTML=`
    ...
    `;const b=t.querySelector("#ai-key");b==null||b.addEventListener("input",()=>{n=!0,h=!1}),(l=t.querySelector("#ref-rpc-base"))==null||l.addEventListener("input",()=>{h=!1})}async function L(){const w=t.querySelector("#ai-key"),x=t.querySelector("#ref-rpc-base");if(!w||!x||!y)return;const b={aiProvider:v??y.aiProvider,refRpcBase:x.value.trim()};n&&(b.aiKey=w.value),e=!0,p=null,h=!1,E(y);try{const l=await Ke(b);if(r)return;y=l,n=!1,e=!1,h=!0,E(l)}catch(l){if(r)return;e=!1,p=String(l instanceof Error?l.message:l),E(y)}}return()=>{r=!0}}const at="local";function st(t){let r=!1,n=!1,e="",p=null;t.innerHTML=`
    <h1>Machines</h1>
    <div id="targets-body"><p class="muted">Loading…</p></div>
    ${D()}
  `;const h=t.querySelector("#targets-body");X(t,(l,c)=>{C(l,c)}),y();async function y(){try{const[l,c,u]=await Promise.all([V(),Y(),Be()]);if(r)return;e=u.os,S(l,c)}catch(l){if(r)return;h.innerHTML=`<p class="error">Failed to load machines: ${s(String(l))}</p>`}}function v(){p&&S(p.targets,p.catalog)}function S(l,c){p={targets:l,catalog:c};const u=e==="linux",$=[...l].sort((N,j)=>(N.mode==="local"?-1:0)-(j.mode==="local"?-1:0)),k=$.length?`<div class="card-grid">${$.map(N=>ot(N,c)).join("")}</div>`:`
