var Le=Object.defineProperty;var Ie=(t,r,n)=>r in t?Le(t,r,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[r]=n;var be=(t,r,n)=>Ie(t,typeof r!="symbol"?r+"":r,n);(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const p of document.querySelectorAll('link[rel="modulepreload"]'))e(p);new MutationObserver(p=>{for(const h of p)if(h.type==="childList")for(const y of h.addedNodes)y.tagName==="LINK"&&y.rel==="modulepreload"&&e(y)}).observe(document,{childList:!0,subtree:!0});function n(p){const h={};return p.integrity&&(h.integrity=p.integrity),p.referrerPolicy&&(h.referrerPolicy=p.referrerPolicy),p.crossOrigin==="use-credentials"?h.credentials="include":p.crossOrigin==="anonymous"?h.credentials="omit":h.credentials="same-origin",h}function e(p){if(p.ep)return;p.ep=!0;const h=n(p);fetch(p.href,h)}})();function Be(){return B("/api/host")}function Y(){return B("/api/catalog")}function V(){return B("/api/targets")}function ve(t){return B("/api/targets",{method:"POST",headers:te,body:JSON.stringify(t)})}function He(t){return B(`/api/targets/${encodeURIComponent(t)}`,{method:"DELETE"})}function Re(t,r){return B(`/api/targets/${encodeURIComponent(t)}/disk?path=${encodeURIComponent(r)}`)}function Ae(t,r){return B(`/api/targets/${encodeURIComponent(t)}/setup`,{method:"POST",headers:te,body:JSON.stringify(r)})}function De(t,r){const n=new EventSource(`/api/targets/${encodeURIComponent(t)}/setup/stream`);return n.onmessage=e=>{try{r(JSON.parse(e.data))}catch{}},()=>n.close()}function Ue(t,r){const n=new EventSource(`/api/targets/${encodeURIComponent(t)}/monitor/stream`);return n.onmessage=e=>{try{r(JSON.parse(e.data))}catch{}},()=>n.close()}function Ne(t,r=200){return B(`/api/targets/${encodeURIComponent(t)}/logs?n=${r}`)}function Me(t,r){const n=new EventSource(`/api/targets/${encodeURIComponent(t)}/logs/stream`);return n.onmessage=e=>{try{r(JSON.parse(e.data))}catch{}},()=>n.close()}function ye(t,r){const n=r===void 0?{}:{lines:r};return B(`/api/targets/${encodeURIComponent(t)}/explain`,{method:"POST",headers:te,body:JSON.stringify(n)})}function qe(t,r,n){return B(`/api/targets/${encodeURIComponent(t)}/services/${r}/${n}`,{method:"POST"})}function Fe(t,r){return B(`/api/targets/${encodeURIComponent(t)}/services/${r}/clear`,{method:"POST",headers:te,body:JSON.stringify({Confirm:r})})}function Oe(t){return B(`/api/targets/${encodeURIComponent(t)}/du`)}function je(t){return B(`/api/targets/${encodeURIComponent(t)}/endpoints`)}function ze(t){return B(`/api/targets/${encodeURIComponent(t)}/firewall`)}function _e(t){return B(`/api/targets/${encodeURIComponent(t)}/diagnostics`)}function We(t){return B(`/api/targets/${encodeURIComponent(t)}/diagnostics/latest`)}function Je(){return B("/api/settings")}function Ke(t){return B("/api/settings",{method:"PUT",headers:te,body:JSON.stringify(t)})}class ue extends Error{constructor(n,e){super(e);be(this,"status");this.name="ApiError",this.status=n}}const te={"Content-Type":"application/json"};async function B(t,r){const n=await fetch(t,r);if(!n.ok){let p=n.statusText||`HTTP ${n.status}`;try{const h=await n.json();h&&typeof h.error=="string"&&h.error&&(p=h.error)}catch{}throw new ue(n.status,p)}if(n.status===204)return;const e=await n.text();return e?JSON.parse(e):void 0}const $e="https://learn.valve.city/rpc";function s(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function D(t,r){const n=t&&r&&r!==$e?` <span class="footer-sep">·</span> <a href="${s(r)}" target="_blank" rel="noopener noreferrer">${s(t)}</a>`:"";return`
  ...
  `}function ee(t){t.querySelectorAll(".dropdown.open").forEach(r=>{var n;r.classList.remove("open"),(n=r.querySelector(".dropdown-trigger"))==null||n.setAttribute("aria-expanded","false")})}function Se(t,r){t.addEventListener("click",p=>{const h=p.target,y=h.closest(".dropdown-trigger");if(y&&t.contains(y)){const S=y.closest(".dropdown"),C=!!S&&!S.classList.contains("open");ee(t),S&&C&&(S.classList.add("open"),y.setAttribute("aria-expanded","true"));return}const b=h.closest(".dropdown-option");if(b&&t.contains(b)){const S=b.closest(".dropdown");ee(t),r((S==null?void 0:S.dataset.dropdown)??"",b.dataset.value??"");return}ee(t)});const n=p=>{if(!t.isConnected){document.removeEventListener("click",n),document.removeEventListener("keydown",e);return}const h=p.target;(!h.closest(".dropdown")||!t.contains(h))&&ee(t)},e=p=>{if(!t.isConnected){document.removeEventListener("click",n),document.removeEventListener("keydown",e);return}p.key==="Escape"&&ee(t)};document.addEventListener("click",n),document.addEventListener("keydown",e)}const Xe=85,ce={exec:"Execution",beacon:"Beacon"};function Ze(t,r){let n=!1,e=null,p=null,h=null,y=null,b=null,S=null,C=null,E=null;const L={exec:null,beacon:null};let w=null;t.innerHTML=`<h1>Dashboard: ${s(r)}</h1><div id="dash-body"><p class="muted">Loading…</p></div><div id="dash-footer">${D()}</div>`;const x=t.querySelector("#dash-body"),v=t.querySelector("#dash-footer");x.addEventListener("click",a=>{const d=a.target.closest("[data-action]");if(!d||!x.contains(d))return;const g=d.dataset.action;if(g==="svc-action"){const f=d.dataset.svc,P=d.dataset.kind;f&&P&&z(f,P)}else if(g==="open-clear"){const f=d.dataset.svc;f&&ie(f)}else if(g==="copy"){const f=d.dataset.copy;f&&oe(d,f)}else g==="retry-du"?c():g==="retry-endpoints"&&u()}),l();async function l(){let a,d;try{const[f,P]=await Promise.all([V(),Y()]);a=f.find(H=>H.id===r),d=P}catch(f){if(n)return;x.innerHTML=`<p class="error">Failed to load target: ${s(String(f))}</p>`;return}if(n)return;if(!a){x.innerHTML=`<p class="error">Target "${s(r)}" not found. <a href="#/targets">Back to targets</a></p>`;return}if(!a.wire){x.innerHTML=`<p class="muted">This target hasn't completed setup yet. <a href="#/setup/${encodeURIComponent(r)}">Run the setup wizard →</a></p>`;return}const g=d==null?void 0:d.networks.find(f=>f.ChainID===a.wire.ChainID);g&&(v.innerHTML=D(g.Name,g.LearnURL)),x.innerHTML='<p class="muted">Connecting…</p>',e=Ue(r,f=>{n||($(f),p=f,h=f,k())}),c(),u()}async function c(){S=null;try{b=await Oe(r)}catch(a){b=null,S=String(a instanceof Error?a.message:a)}n||k()}async function u(){E=null;try{C=await je(r)}catch(a){C=null,E=String(a instanceof Error?a.message:a)}n||k()}function $(a){if(!p)return;const d=(new Date(a.at).getTime()-new Date(p.at).getTime())/1e3,g=a.execHead-p.execHead;if(d>0&&g>=0){const f=g/d;y=y===null?f:y*.7+f*.3}}function k(){if(!h)return;const a=h;x.innerHTML=`
      <div class="card-grid">
        ${U(a)}
        ${N(a)}
        ${j(a)}
    ...
    `}function Q(a){if(S)return`
      ...
      `;if(!b)return'<div class="card"><h3>Storage</h3><p class="muted">Loading…</p></div>';const d=b.ExpectedExecBytes>0?Math.min(b.ExecBytes/b.ExpectedExecBytes*100,100):0,g=b.ExpectedBeaconBytes>0?Math.min(b.BeaconBytes/b.ExpectedBeaconBytes*100,100):0,{lag:f,eta:P}=R(a),H=f!==null&&f>0&&y!==null&&y>0;return`
      <div class="card">
        <h3>Storage</h3>
        ...
        ${H?`<p class="muted small">Estimated time remaining: ${s(P)}</p>`:""}
    ...
    `}function A(a,d){const g=ce[a],f=L[a],P=(H,T,F)=>`<button class="btn btn-ghost" data-action="svc-action" data-svc="${a}" data-kind="${H}" ${f!==null||F?"disabled":""}>${f===H?G():s(T)}</button>`;return`
      <div class="service-row">
        <span>${s(g)} ${d?I("active","ok"):I("down","bad")}</span>
  ...
  `}function ct(t){return t.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")||"target"}const le=[{id:"preflight",title:"Preflight checks"},{id:"toolchain",title:"Ensure git + build toolchains"},{id:"install-exec",title:"Install execution client"},{id:"install-beacon",title:"Install beacon client"},{id:"wire",title:"Write JWT secret and systemd units"},{id:"start",title:"Start execution and beacon services"},{id:"handshake",title:"Verify execution/beacon handshake"}],re=8545,ae=5052,se=30303,lt=[369,943,1],Te={369:"default",943:"practise here first"};function dt(t,r){let n=!1;const e={targetId:r,step:"network",catalog:null,loadError:null,chainId:369,execId:null,beaconId:null,archive:!0,dataDir:"",jwtPath:"",execHTTPPort:"",beaconHTTPPort:"",execP2PPort:"",execHTTPPortError:null,beaconHTTPPortError:null,execP2PPortError:null,rpcBindAddr:"",rpcBindAddrError:null,freeBytes:null,probedPath:null,diskProbing:!1,diskError:null,downgradeNote:null,checkpoint:!0,checkpointUrl:"",checkpointUrlError:null,starting:!1,startError:null,events:[],streamStop:null};t.innerHTML=`<h1>Setup: ${s(r)}</h1><div id="wizard-body"><p class="muted">Loading catalog…</p></div><div id="wizard-footer">${D()}</div>`;const p=t.querySelector("#wizard-body"),h=t.querySelector("#wizard-footer");X(t,(i,o)=>{Q(i,o)}),Se(t,(i,o)=>{i==="exec-select"?e.execId=o:i==="beacon-select"&&(e.beaconId=o),b()}),t.addEventListener("change",i=>{const o=i.target;o instanceof HTMLInputElement&&(o.id==="data-dir-input"?(_(),u()):o.id==="checkpoint-toggle"&&(e.checkpoint=o.checked,b()))}),y();async function y(){try{const[i,o]=await Promise.all([Y(),V()]);if(n)return;e.catalog=i;const m=o.find(a=>a.id===r);m!=null&&m.wire&&(e.chainId=m.wire.ChainID,e.execId=m.wire.ExecID,e.beaconId=m.wire.BeaconID,e.archive=m.wire.Archive,m.wire.ExecHTTPPort&&(e.execHTTPPort=String(m.wire.ExecHTTPPort)),m.wire.BeaconHTTPPort&&(e.beaconHTTPPort=String(m.wire.BeaconHTTPPort)),m.wire.ExecP2PPort&&(e.execP2PPort=String(m.wire.ExecP2PPort)),m.wire.RPCBindAddr&&(e.rpcBindAddr=m.wire.RPCBindAddr)),b()}catch(i){if(n)return;e.loadError=String(i instanceof Error?i.message:i),b()}}function b(){if(e.loadError){p.innerHTML=`<p class="error">Failed to load: ${s(e.loadError)}</p>`;return}e.catalog&&(p.innerHTML=`
    ...
    `,S())}function S(){var o;const i=(o=e.catalog)==null?void 0:o.networks.find(m=>m.ChainID===e.chainId);h.innerHTML=i?D(i.Name,i.LearnURL):D()}function C(){switch(e.step){case"network":return E();case"clients":return L();case"mode":return N();case"review":return j();case"run":return Z()}}function E(){const i=e.catalog;return`
      <section>
        ...
        <div class="card-grid">${lt.map(m=>{const a=i.networks.find(f=>f.ChainID===m);if(!a)return"";const d=e.chainId===m,g=Te[m]?I(Te[m],m===369?"ok":"warn"):"";return`
      ...
      <section>
        ...
        <table class="compare-table">
          ...
          <tbody>
            ...
            <tr><th>Initial sync time${g}</th><td class="yes">${o?s(o.SyncLabel):"Faster"}</td><td class="limited">${o?s(o.GenesisSyncLabel):"Much slower"}</td></tr>
